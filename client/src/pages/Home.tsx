...
export default function Home() {
  ...
  return (
    <main>
      {/* Hero Section (White) */}
      <section className="section section--white" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", paddingTop: "4rem" }}>
        {/* Background video */}
        {!videoError ? (
          <video
